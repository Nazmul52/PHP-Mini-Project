<?php
	...
	if(isset($_POST['login'])) {
		...
		if($errMsg == '') {
			try {
				$stmt = $connect->prepare('SELECT id, fullname, username, password, secretpin, user_type FROM users_details WHERE username = :username');
...
<body>
	<div align="center">
		<div style=" border: solid 1px #006D9C; " align="left">
            ...
            <a href="index.php" style="float: right; color: white; font-size: 18px; font-weight: bold;text-decoration: none;">Back</a>
			</div>
